        ...
        children: [
            /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                ...
                children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                    ...
                    children: [
                        /*#__PURE__*/ _jsxDevRuntime.jsxDEV(HomeHeaderContainer, {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ _jsxDevRuntime.jsxDEV(TypewriterHeaderWrapper, {
                                    children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV("p", {
                                        className: "mt-2 text-3xl leading-normal font-extrabold tracking-tight text-gray-900 sm:text-4xl",
                        ...
                        /*#__PURE__*/ _jsxDevRuntime.jsxDEV(_homeSearchBarDefault.default, {
                        }, void 0, false, {
                            fileName: "src/components/Home/index.tsx",
                            lineNumber: 24,
                            columnNumber: 11
            ...
            /*#__PURE__*/ _jsxDevRuntime.jsxDEV(_homeTokenListDefault.default, {
            }, void 0, false, {
                fileName: "src/components/Home/index.tsx",
                lineNumber: 28,
                columnNumber: 7
            }, undefined),
            /*#__PURE__*/ _jsxDevRuntime.jsxDEV(_footerDefault.default, {
            }, void 0, false, {
                fileName: "src/components/Home/index.tsx",
                lineNumber: 29,
                columnNumber: 7
...
_c2 = HomeContainer;
const HomeHeaderContainer = _styledComponentsDefault.default.div`
...
},{"react/jsx-dev-runtime":"3jZUD","react":"4mchR","styled-components":"dOPCJ","~/src/contexts/Home":"d1Rfi","~/src/utils/ProviderHOC":"bPUxl","../Public/Footer":"7IE0T","./HomeSearchBar":"16RE2","./HomeTokenList":"kUCev","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"9pz13"}],"dOPCJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class HomeProvider extends _reactDefault.default.PureComponent {
    constructor(props){
        super(props);
        this.fetchCoinList = async ()=>{
            try {
                this.setState({
                    isFetching: true
                });
                const coinList = await _coins.getCoinList();
                this.setState({
                    coinList,
        ...
        this.fetchUserCoins = async ()=>{
            try {
                const userCoinList = await _simple.getSimplePrice({
                    ids: localStorage.getItem(_homeContext.STORAGE_KEY) || '',
                    vs_currencies: 'usd',
        ...
        this.tempToggleLoading = ()=>this.setState(({ isFetching  })=>({
                    isFetching: !isFetching
                })
            )
        ;
        this.filterCoinList = (filterKey)=>{
            const filterKeyLower = filterKey.toLowerCase();
            this.setState(({ coinList  })=>({
                    filteredCoinList: coinList.filter(({ symbol , name  })=>symbol.includes(filterKeyLower) || name.toLowerCase().includes(filterKeyLower)
                    ).sort((a, b)=>{
        ...
        this.handleDelete = (id)=>()=>{
                ...
                const currentSavedList = localStorage.getItem(_homeContext.STORAGE_KEY);
                localStorage.setItem(_homeContext.STORAGE_KEY, currentSavedList?.replace(`${id},`, '') || '');
            }
        ;
        this.actions = {
     ...
     */ if (localStorage.getItem(_homeContext.STORAGE_KEY) === null) localStorage.setItem(_homeContext.STORAGE_KEY, BASIC_COIN_LIST);
        this.fetchCoinList();
        this.fetchUserCoins();
    }
    render() {
...
const getCoinList = ()=>_requestDefault.default.get('/coins/list')
;

},{"~/src/utils/request":"1Tppv","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"1Tppv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Request {
    constructor(){
        ...
        // Axios Methods
        this.get = (...args)=>this.instance.get(...args)
        ;
        this.delete = (...args)=>this.instance.delete(...args)
        ;
        this.head = (...args)=>this.instance.head(...args)
        ;
        this.post = (...args)=>this.instance.post(...args)
        ;
        this.put = (...args)=>this.instance.put(...args)
        ;
        this.patch = (...args)=>this.instance.patch(...args)
        ;
        this.instance.interceptors.response.use(({ data  })=>{
            return data;
        }, (error)=>_reactToastify.toast.error(JSON.stringify(error))
        );
    }
}
...
},{}],"lHBz1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _request = require("~/src/utils/request");
var _requestDefault = parcelHelpers.interopDefault(_request);
const getSimplePrice = (params)=>_requestDefault.default.get('/simple/price', {
        params
    })
;

},{"~/src/utils/request":"1Tppv","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"bPUxl":[function(require,module,exports) {
...
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$fb3a.prelude(module);
...
var _styledComponentsDefault = parcelHelpers.interopDefault(_styledComponents);
const Footer = ()=>{
    return(/*#__PURE__*/ _jsxDevRuntime.jsxDEV(FooterContainer, {
        className: "text-xs text-gray-500",
        children: [
            /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                children: [
                    `Built by `,
                    /*#__PURE__*/ _jsxDevRuntime.jsxDEV(GithubLink, {
...
const FooterContainer = _styledComponentsDefault.default.footer`
  width: 100%;
  text-align: center;
...
`;
_c1 = FooterContainer;
const GithubLink = _styledComponentsDefault.default.a``;
_c2 = GithubLink;
var _c, _c1, _c2;
...
$RefreshReg$(_c2, "GithubLink");
  ...
  $parcel$ReactRefreshHelpers$fb3a.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-dev-runtime":"3jZUD","react":"4mchR","styled-components":"dOPCJ","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"9pz13"}],"16RE2":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$eed7 = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$eed7.prelude(module);
...
const HomeSearchBar = ()=>{
    _s();
    const { filteredCoinList , userCoinList , filterCoinList , fetchUserCoins  } = _home.useHome();
    const [searchFocused, setSearchFocused] = _react.useState(false);
    const parentRef = _reactDefault.default.useRef(null);
    const { totalSize , virtualItems  } = _reactVirtual.useVirtual({
    ...
    const handleDropdownItemClick = ({ id  })=>()=>{
            ...
            if (!currentSavedList?.split(',').includes(id)) {
                localStorage.setItem(_homeContext.STORAGE_KEY, `${currentSavedList || ''}${id},`);
                fetchUserCoins();
            }
        }
    ;
    return(/*#__PURE__*/ _jsxDevRuntime.jsxDEV(_jsxDevRuntime.Fragment, {
        children: [
            /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                ...
                children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV(StyledHomeSearchBar, {
            ...
            /*#__PURE__*/ _jsxDevRuntime.jsxDEV(SearchResultDropdown, {
                ref: parentRef,
                ...
                children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV(DropdownContainer, {
                    $height: `${totalSize}px`,
                    children: virtualItems.map(({ index , size , start  })=>/*#__PURE__*/ _jsxDevRuntime.jsxDEV(DropdownVirtualItem, {
...
_s(HomeSearchBar, "K0oam4A6Magi5/uuJv2iYE9EKs0=", false, function() {
    return [
        _home.useHome,
        _reactVirtual.useVirtual
    ];
});
_c = HomeSearchBar;
exports.default = HomeSearchBar;
const StyledHomeSearchBar = _styledComponentsDefault.default.input`
  width: 450px;
  @media screen and (max-width: 1024px) {
    width: calc(100%);
  }
...
const SearchResultDropdown = _styledComponentsDefault.default.div`
  width: 420px;
  max-height: 50vh;
...
const DropdownContainer = _styledComponentsDefault.default.div`
 ...
 */ const DropdownVirtualItem = _styledComponentsDefault.default.div`
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
  ...
  ${({ $selected  })=>$selected ? _styledComponents.css`
          background: #eee;
          color: #aaa;
...
$RefreshReg$(_c4, "DropdownVirtualItem");
  ...
  $parcel$ReactRefreshHelpers$eed7.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-dev-runtime":"3jZUD","react":"4mchR","react-virtual":"1nBpS","styled-components":"dOPCJ","~/src/contexts/Home/HomeContext":"9bX35","~/src/contexts/Home":"d1Rfi","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"9pz13"}],"1nBpS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var run = function run1() {
    ...
    rafId = window.requestAnimationFrame(run1);
};
...
var useIsomorphicLayoutEffect = typeof window !== 'undefined' ? _reactDefault.default.useLayoutEffect : _reactDefault.default.useEffect;
function useRect(nodeRef, initialRect) {
    if (initialRect === void 0) initialRect = {
        width: 0,
        height: 0
    };
    var _React$useState = _reactDefault.default.useState(nodeRef.current), element = _React$useState[0], setElement = _React$useState[1];
    var _React$useReducer = _reactDefault.default.useReducer(rectReducer, initialRect), rect1 = _React$useReducer[0], dispatch = _React$useReducer[1];
    var initialRectSet = _reactDefault.default.useRef(false);
...
var useElementScroll = function useElementScroll(_ref) {
    ...
    var _React$useState = _reactDefault.default.useState(0), scrollOffset = _React$useState[0], setScrollOffset = _React$useState[1];
    var _React$useState2 = _reactDefault.default.useState(parentRef.current), element = _React$useState2[0], setElement = _React$useState2[1];
    useIsomorphicLayoutEffect(function() {
    ...
    var scrollToFn = _reactDefault.default.useCallback(function(offset) {
...
var useWindowRect = function useWindowRect(windowRef, initialRect) {
    ...
    var _React$useState3 = _reactDefault.default.useState(initialRect), rect = _React$useState3[0], setRect = _React$useState3[1];
    var _React$useState4 = _reactDefault.default.useState(windowRef.current), element = _React$useState4[0], setElement = _React$useState4[1];
    useIsomorphicLayoutEffect(function() {
...
var useWindowScroll = function useWindowScroll(_ref2) {
    ...
    var _React$useState5 = _reactDefault.default.useState(0), scrollOffset = _React$useState5[0], setScrollOffset = _React$useState5[1];
    var _React$useState6 = _reactDefault.default.useState(windowRef.current), element = _React$useState6[0], setElement = _React$useState6[1];
    var parentOffsetRef = _reactDefault.default.useRef(0);
    ...
    var scrollToFn = _reactDefault.default.useCallback(function(offset, reason) {
        if (windowRef.current) {
            ...
            windowRef.current.scrollTo((_windowRef$current$sc = {
            }, _windowRef$current$sc[rectKey] = offset + delta, _windowRef$current$sc));
        }
    }, [
        windowRef,
        rectKey
...
var useDefaultScroll = function useDefaultScroll(props1) {
    var parentRef = props1.parentRef, windowRef = props1.windowRef;
    var useWindow = windowRef !== undefined;
    var emptyRef = _reactDefault.default.useRef(null);
    var elementRes = useElementScroll(_extends(_extends({
    }, props1), {
    }, {
        parentRef: useWindow ? emptyRef : parentRef
    }));
    var windowRes = useWindowScroll(_extends(_extends({
    }, props1), {
    }, {
...
function useVirtual(_ref3) {
    ...
    var latestRef = _reactDefault.default.useRef({
        scrollOffset: 0,
        measurements: []
    });
    ...
    }), outerSize1 = _useScroll.outerSize, scrollOffset1 = _useScroll.scrollOffset, defaultScrollToFn = _useScroll.scrollToFn;
    var scrollOffsetWithAdjustmentsRef = _reactDefault.default.useRef(scrollOffset1);
    if (latestRef.current.scrollOffset !== scrollOffset1) scrollOffsetWithAdjustmentsRef.current = scrollOffset1;
    latestRef.current.outerSize = outerSize1;
    latestRef.current.scrollOffset = scrollOffset1;
    var scrollTo = _reactDefault.default.useCallback(function(offset1, reason) {
        var resolvedScrollToFn = scrollToFn || function(offset) {
            return defaultScrollToFn(offset, reason);
        };
        resolvedScrollToFn(offset1, defaultScrollToFn);
    }, [
        scrollToFn,
        defaultScrollToFn
    ]);
    var _React$useState7 = _reactDefault.default.useState({
    }), measuredCache = _React$useState7[0], setMeasuredCache = _React$useState7[1];
    var measure = _reactDefault.default.useCallback(function() {
        return setMeasuredCache({
        });
    }, []);
    var pendingMeasuredCacheIndexesRef = _reactDefault.default.useRef([]);
    var measurements1 = _reactDefault.default.useMemo(function() {
    ...
    var totalSize = (((_measurements = measurements1[size - 1]) == null ? void 0 : _measurements.end) || 0) + paddingEnd;
    latestRef.current.measurements = measurements1;
    latestRef.current.totalSize = totalSize;
    var _calculateRange = calculateRange(latestRef.current), start = _calculateRange.start, end = _calculateRange.end;
    var indexes = _reactDefault.default.useMemo(function() {
        return rangeExtractor({
            start: start,
            end: end,
            overscan: overscan,
            size: measurements1.length
        });
    }, [
        start,
        end,
    ...
    var measureSizeRef = _reactDefault.default.useRef(measureSize);
    measureSizeRef.current = measureSize;
    var virtualItems1 = _reactDefault.default.useMemo(function() {
        var virtualItems = [];
        var _loop = function _loop(k, len) {
            var i = indexes[k];
            var measurement = measurements1[i];
                    ...
                    if (el) {
                        ...
                        if (measuredSize !== item.size) {
                            ...
                            setMeasuredCache(function(old) {
                                ...
                                }, _extends2[item.key] = measuredSize, _extends2));
                            });
                        }
                    }
                }
    ...
    var mountedRef = _reactDefault.default.useRef(false);
    useIsomorphicLayoutEffect(function() {
    ...
    var scrollToOffset = _reactDefault.default.useCallback(function(toOffset, _temp, reason) {
        var _ref4 = _temp === void 0 ? {
        } : _temp, _ref4$align = _ref4.align, align = _ref4$align === void 0 ? 'start' : _ref4$align;
    ...
    var tryScrollToIndex = _reactDefault.default.useCallback(function(index, _temp2) {
        var _ref5 = _temp2 === void 0 ? {
        } : _temp2, _ref5$align = _ref5.align, align = _ref5$align === void 0 ? 'auto' : _ref5$align, rest = _objectWithoutPropertiesLoose(_ref5, [
            "align"
        ]);
    ...
    var scrollToIndex = _reactDefault.default.useCallback(function() {
...
},{"react":"4mchR","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"kUCev":[function(require,module,exports) {
...
const HomeTokenList = ()=>{
    _s();
    const { isFirstLoad , isFetching , userCoinList , handleDelete  } = _home.useHome();
    const tableRef = _react.useRef(null);
    const [showDelete, setShowDelete] = _react.useState(false);
    const toggleDeleteState = ()=>setShowDelete(!showDelete)
    ;
    const sortedUserCoinList = _react.useMemo(()=>Object.entries(userCoinList).sort(([, a], [, b])=>a.usd_market_cap > b.usd_market_cap ? -1 : 1
        )
    , [
        userCoinList
    ]);
        ...
        children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV("table", {
            ...
            children: [
                ...
                /*#__PURE__*/ _jsxDevRuntime.jsxDEV("tbody", {
                    children: [
                        isFirstLoad && /*#__PURE__*/ _jsxDevRuntime.jsxDEV("tr", {
                            children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV("td", {
                                colSpan: 10,
                                children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV(_loadingDefault.default, {
                                    type: "card"
                                }, void 0, false, {
                                    fileName: "src/components/Home/HomeTokenList.tsx",
                                    lineNumber: 75,
                        ...
                        sortedUserCoinList.length > 0 ? sortedUserCoinList.map(([key, { usd , usd_market_cap , usd_24h_change , usd_24h_vol  }])=>/*#__PURE__*/ _jsxDevRuntime.jsxDEV(DataTableRow, {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ _jsxDevRuntime.jsxDEV("td", {
                                        ...
                                        children: _common.formatNumber(usd)
                                    }, void 0, false, {
                                        fileName: "src/components/Home/HomeTokenList.tsx",
                                        lineNumber: 84,
                                        columnNumber: 17
                                    ...
                                    /*#__PURE__*/ _jsxDevRuntime.jsxDEV("td", {
                                        className: "p-4",
                                        children: _common.formatNumber(usd_market_cap, true)
                                    }, void 0, false, {
                                        fileName: "src/components/Home/HomeTokenList.tsx",
                                        lineNumber: 85,
                                        columnNumber: 17
                                    ...
                                    /*#__PURE__*/ _jsxDevRuntime.jsxDEV("td", {
                                        className: `p-4 ${getChangeIndicator(usd_24h_change)}`,
                                        children: [
                                            _common.formatNumber(usd_24h_change),
                                            " %"
                                        ]
                                    }, void 0, true, {
                                        fileName: "src/components/Home/HomeTokenList.tsx",
                                    ...
                                    /*#__PURE__*/ _jsxDevRuntime.jsxDEV("td", {
                                        ...
                                        children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                                                    children: _common.formatNumber(usd_24h_vol, true)
                                                }, void 0, false, {
                                                    fileName: "src/components/Home/HomeTokenList.tsx",
                                                    lineNumber: 89,
                                                    columnNumber: 21
                                                }, undefined),
                                                showDelete && /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
...
_s(HomeTokenList, "qeAsLXz45M2MQmBBa3LucOVzqok=", false, function() {
    return [
        _home.useHome
    ];
});
...
},{"react/jsx-dev-runtime":"3jZUD","react":"4mchR","styled-components":"dOPCJ","~/src/contexts/Home":"d1Rfi","~/src/utils/Common":"en2Ac","../Public/Loading":"9k4rd","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"9pz13"}],"en2Ac":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"9k4rd":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$3132 = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$3132.prelude(module);
...
const Loading = ({ type  })=>{
    switch(type){
        ...
        default:
            return(/*#__PURE__*/ _jsxDevRuntime.jsxDEV(SpinnerContainer, {
                children: /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
                    className: "lds-ring",
                    children: [
                        /*#__PURE__*/ _jsxDevRuntime.jsxDEV("div", {
...
_c = Loading;
exports.default = /*#__PURE__*/ _c1 = _react.memo(Loading);
const SpinnerContainer = _styledComponentsDefault.default.div`
  width: 100%;
  display: flex;
...
$RefreshReg$(_c2, "SpinnerContainer");
  ...
  $parcel$ReactRefreshHelpers$3132.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-dev-runtime":"3jZUD","react":"4mchR","styled-components":"dOPCJ","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"9pz13"}]},["emU3S","v3ZCU"], null, "parcelRequire4e1e")
